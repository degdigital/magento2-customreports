...
class SaveTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->automatedExportRepository = $this->createMock(\DEG\CustomReports\Api\AutomatedExportRepositoryInterface::class);
        $this->automatedExportFactory = $this->createMock(AutomatedExportInterfaceFactory::class);
        $this->save = new Save($this->context, $this->dataPersistor, $this->automatedExportRepository, $this->automatedExportFactory);
    }
    ...
    public function testExecute(): void
    {
        ...
        $customReportMock = $this->createMock(\DEG\CustomReports\Model\AutomatedExport::class);
