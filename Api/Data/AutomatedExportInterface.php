 ...
 * @method string getErrorEmails()
 * @method string getRemoteHost()
 * @method string getRemotePort()
 * @method string getRemoteUsername()
 * @method string getRemotePassword()
 * @method string getRemoteLocation()
 ...
 * @method AutomatedExportInterface setErrorEmails(string $errorEmails)
 * @method AutomatedExportInterface setRemoteHost(string $remoteHost)
 * @method AutomatedExportInterface setRemotePort(string $remotePort)
 * @method AutomatedExportInterface setRemoteUsername(string $remoteUsername)
 * @method AutomatedExportInterface setRemotePassword(string $remotePassword)
 * @method AutomatedExportInterface setRemoteLocation(string $remoteLocation)
